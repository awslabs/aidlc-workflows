...
| **GitHub Copilot** (VS Code ≥ 1.102) | `dist/copilot/` → `<project>/` (`.github/` + `aidlc/` + `AGENTS.md`) | `/aidlc` | [Quick Start](#quick-start) below + [AI-DLC on GitHub Copilot](docs/guide/harnesses/copilot.md). |
