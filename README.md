...
AI-DLC Workflows 2.0 is GA on the repository's default
[`main` branch](https://github.com/awslabs/aidlc-workflows/tree/main). New
installations and upgrades use `main`, which contains the current multi-harness
implementation. Read the
[AI-DLC Workflows 2.0 Specification](https://github.com/awslabs/aidlc-workflows/blob/main/assets/AI-DLC-Workflows-2.0-Specification.pdf)
for its architecture and operating model.

This `v1` branch remains available for existing v1 installations and
maintenance. The setup and release instructions below apply to v1.
...
2. Ask Codex: for an existing project - "Using AI-DLC, analyze the project" or for a new project - "Using AI-DLC, what workflow do you see?"
...
>
> The resiliency extension rules are provided as directional best practices for building resilient workloads within AI-DLC workflows. Each organization should build, customize, and thoroughly test their own resiliency rules before deploying in production workflows.
