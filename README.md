...
even in an elevated PowerShell session, and automatically registers the bin
directory in User PATH. Open a new terminal if another session cannot find
`aidlc`. To skip both persistent and current-process PATH changes, use
