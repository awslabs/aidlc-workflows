...
- **[11 adaptive scopes](docs/guide/05-scopes-and-depth.md)** (enterprise through express, with classic as the freeform default and workshop retained for facilitated sessions) plus an **[adaptive composer](docs/guide/05-scopes-and-depth.md#the-adaptive-composer)** (`/aidlc compose`) that proposes a tailored stage plan from your task, a scan report, or the running workflow
