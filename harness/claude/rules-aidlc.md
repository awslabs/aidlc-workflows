<!--
  ...
  ../../aidlc/spaces/default/memory/. Paths point at the always-present
  `default` space (the resolver follows the active-space cursor on its own; the
  ambient re-point on space switch is a fast-follow).
