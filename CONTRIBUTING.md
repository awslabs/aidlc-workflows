...
AI-DLC ships to many agent harnesses (today Claude Code, Kiro (IDE and CLI), Codex CLI, opencode, and GitHub Copilot) from a single hand-authored source. The layout has three zones:
