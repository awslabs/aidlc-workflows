...
- Read the selected file only through the fixed command
  `bun .codex/tools/aidlc-utility.ts document-input`.
...
`bun .codex/tools/aidlc.ts engine orchestrate report --stage requirements-analysis --result <outcome>`.
...
`bun .codex/tools/aidlc.ts engine recompose --add user-stories`
