...
`bun .aidlc/tools/aidlc.ts engine orchestrate report --stage requirements-analysis --result <outcome>`.
...
`bun .aidlc/tools/aidlc.ts engine recompose --add user-stories`
