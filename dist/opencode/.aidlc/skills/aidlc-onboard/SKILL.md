...
```bash
bun .aidlc/tools/aidlc-onboard.ts capture \
...
```bash
bun .aidlc/tools/aidlc-onboard.ts classify \
...
```bash
bun .aidlc/tools/aidlc-onboard.ts list
```
...
```bash
bun .aidlc/tools/aidlc-learnings.ts persist-rule \
  --scope <project|team> \
