...
const shippedAidlcEntrypoints: ReadonlySet<string> = new Set<string>(
  /* @aidlc-shipped-entrypoints@ */ [
    ...
    "tools/aidlc-review-ui-acp.ts",
    "tools/aidlc-review-ui-decision.ts",
    "tools/aidlc-review-ui-publish.ts",
    "tools/aidlc-review-ui-render.ts",
    "tools/aidlc-review-ui-runs.ts",
    "tools/aidlc-review-ui-shared.ts",
    "tools/aidlc-review-ui-workflow.ts",
    "tools/aidlc-review-ui.ts",
    ...
    "tools/aidlc-sensor-html-shape.ts",
