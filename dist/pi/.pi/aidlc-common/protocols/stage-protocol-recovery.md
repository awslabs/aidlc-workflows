...
- Load `.pi/rules/aidlc-team.md` if affirmation already happened (re-run pre-fill from prior affirmed sections)
- Load `.pi/rules/aidlc-org.md` for greenfield default suggestions
