...
`bun .aidlc/tools/aidlc.ts engine orchestrate report --stage delivery-planning --result <outcome>`.
...
`bun .aidlc/tools/aidlc.ts engine state set-construction-iteration unit-major`.
