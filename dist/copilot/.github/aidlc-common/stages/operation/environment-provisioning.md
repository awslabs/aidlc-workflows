...
Load aidlc-aws-platform-agent persona from `agents/aidlc-aws-platform-agent.md` and knowledge from `.github/knowledge/aidlc-aws-platform-agent/`.
...
`bun .github/tools/aidlc-orchestrate.ts report --stage environment-provisioning --result <outcome>`.
