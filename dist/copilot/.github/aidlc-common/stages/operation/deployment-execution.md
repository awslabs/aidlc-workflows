...
Load aidlc-pipeline-deploy-agent persona from `agents/aidlc-pipeline-deploy-agent.md` and knowledge from `.github/knowledge/aidlc-pipeline-deploy-agent/`.
...
`bun .github/tools/aidlc-orchestrate.ts report --stage deployment-execution --result <outcome>`.
