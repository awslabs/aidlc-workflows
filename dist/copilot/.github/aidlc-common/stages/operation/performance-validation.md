...
Load aidlc-quality-agent persona from `agents/aidlc-quality-agent.md` and knowledge from `.github/knowledge/aidlc-quality-agent/`.
...
`bun .github/tools/aidlc-orchestrate.ts report --stage performance-validation --result <outcome>`.
