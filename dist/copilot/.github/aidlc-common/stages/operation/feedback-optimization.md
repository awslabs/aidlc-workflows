...
Load aidlc-operations-agent persona from `agents/aidlc-operations-agent.md` and knowledge from `.github/knowledge/aidlc-operations-agent/`.
...
`bun .github/tools/aidlc-orchestrate.ts report --stage feedback-optimization --result <outcome>`.
