...
`bun .github/tools/aidlc-orchestrate.ts report --stage reverse-engineering --result skipped --reason "<reason>"`.
...
Template in
`.github/knowledge/aidlc-developer-agent/re-artifacts.md`.
...
```
bun .github/tools/aidlc-utility.ts codekb-path --repo <repo>
```
...
`bun .github/tools/aidlc-orchestrate.ts report --stage reverse-engineering --result <outcome>`.
