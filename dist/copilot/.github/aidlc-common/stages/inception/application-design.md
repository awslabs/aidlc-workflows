...
Load aidlc-architect-agent persona from `agents/aidlc-architect-agent.md` and knowledge from `.github/knowledge/aidlc-architect-agent/`.
Load aidlc-aws-platform-agent persona from `agents/aidlc-aws-platform-agent.md` and knowledge from `.github/knowledge/aidlc-aws-platform-agent/` for AWS service mapping.
Load aidlc-design-agent persona from `agents/aidlc-design-agent.md` and knowledge from `.github/knowledge/aidlc-design-agent/` for UI component specifications and UX-informed design constraints.
...
`bun .github/tools/aidlc-orchestrate.ts report --stage application-design --result <outcome>`.
...
`bun .github/tools/aidlc-utility.ts recompose --add units-generation`
