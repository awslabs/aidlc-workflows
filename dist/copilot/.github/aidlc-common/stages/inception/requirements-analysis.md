...
Load aidlc-product-agent persona from `agents/aidlc-product-agent.md` and knowledge from `.github/knowledge/aidlc-product-agent/`.
...
`bun .github/tools/aidlc-orchestrate.ts report --stage requirements-analysis --result <outcome>`.
...
`bun .github/tools/aidlc-utility.ts recompose --add user-stories`
