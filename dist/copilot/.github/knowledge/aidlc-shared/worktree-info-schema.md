...
```
bun .github/tools/aidlc-worktree.ts info --slug <kebab-slug>
```
...
- Implementation: `.github/tools/aidlc-worktree.ts` (`handleInfo` handler)
- Test: `tests/unit/t72-worktree-info.sh`
- Caller: `.github/skills/aidlc/SKILL.md` (per-Bolt-loop halt-and-ask flow)
...
- Audit-format spec: `.github/knowledge/aidlc-shared/audit-format.md` `WORKTREE_CREATED` row
