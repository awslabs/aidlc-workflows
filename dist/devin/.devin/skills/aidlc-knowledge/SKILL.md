...
```bash
bun .devin/tools/aidlc-knowledge.ts <verb> [args]
```
...
```bash
bun .devin/tools/aidlc-knowledge.ts list
```
...
```bash
bun .devin/tools/aidlc-knowledge.ts onboard aidlc/spaces/<space>/knowledge/documents/policy.pdf
```
...
```bash
bun .devin/tools/aidlc-knowledge.ts onboard
```
...
```bash
bun .devin/tools/aidlc-knowledge.ts show <id> --json
```
...
```bash
bun .devin/tools/aidlc-knowledge.ts sync
```
...
```bash
bun .devin/tools/aidlc-knowledge.ts rebind <id> --to aidlc/spaces/<space>/knowledge/documents/moved.pdf
```
...
```bash
bun .devin/tools/aidlc-knowledge.ts summarize <id> \
