...
2. Execute the jump through the ENGINE: run
   `bun .devin/tools/aidlc-orchestrate.ts next --stage code-generation`.
...
4. Every worker brief starts with the output of
   `bun .devin/tools/aidlc-testing-posture.ts brief --unit <unit>`,
