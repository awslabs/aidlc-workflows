...
Load aidlc-aws-platform-agent persona from `agents/aidlc-aws-platform-agent.md` and knowledge from `.cursor/knowledge/aidlc-aws-platform-agent/` for AWS service mapping.
