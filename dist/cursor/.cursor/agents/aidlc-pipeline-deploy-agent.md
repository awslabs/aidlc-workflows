...
- Read team practices via `.cursor/rules/aidlc-team.md` (fall back to `org.md` per `knowledge/aidlc-shared/rules-reading.md`); match the affirmed branching strategy to one of the five in `branching-strategies.md`
...
1. `.cursor/rules/` -- execution guardrails
...
4. `.cursor/rules/` -- team-affirmed practices (read per `knowledge/aidlc-shared/rules-reading.md`)
