...
function renderPanel() {
  ...
  <footer class="workflow-footer"><span class="agent-dot ${escapeHtml(workflow.agent_status || "idle")}"></span><span>Agent ${escapeHtml(workflow.agent_status || "idle")}</span><button type="button" data-all-files>All files</button><span class="audit-link" title="see aidlc/spaces/${escapeHtml(workflow.space || "default")}/intents/${escapeHtml(workflow.intent || "…")}/audit/">Audit log</span></footer>`;
}
