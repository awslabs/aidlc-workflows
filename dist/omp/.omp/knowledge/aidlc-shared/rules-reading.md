...
1. **`.omp/aidlc-common/rules/aidlc-team.md`** — team-affirmed practices. The
   primary source.
2. **`.omp/aidlc-common/rules/aidlc-org.md`** — framework defaults written in team
