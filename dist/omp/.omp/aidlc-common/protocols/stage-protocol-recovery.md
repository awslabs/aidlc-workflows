...
- Load `.omp/aidlc-common/rules/aidlc-team.md` if affirmation already happened (re-run pre-fill from prior affirmed sections)
- Load `.omp/aidlc-common/rules/aidlc-org.md` for greenfield default suggestions
