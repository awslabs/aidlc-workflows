...
Load aidlc-delivery-agent persona from `agents/aidlc-delivery-agent.md` and knowledge from `.omp/knowledge/aidlc-delivery-agent/`.
...
**If practices-discovery executed**, read `.omp/aidlc-common/rules/aidlc-team.md` via `extractMarkdownSection` for three sections that influence Bolt planning:
