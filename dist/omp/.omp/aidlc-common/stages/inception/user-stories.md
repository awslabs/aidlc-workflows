...
Load aidlc-design-agent persona from `agents/aidlc-design-agent.md` and knowledge from `.omp/knowledge/aidlc-design-agent/` for supporting perspective on user experience.
