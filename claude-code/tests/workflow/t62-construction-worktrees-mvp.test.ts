...
//     setup_construction_project helper, _construction-worktrees-helpers.sh:
//     36-43) and reads back the written aidlc-state.md. The template
...
// (_construction-worktrees-helpers.sh:67-119). They are NOT part of this .sh's
...
/**
 * setup_construction_project (mvp) — _construction-worktrees-helpers.sh:36-43.
