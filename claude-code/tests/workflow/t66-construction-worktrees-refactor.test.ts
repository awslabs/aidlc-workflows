...
// tests/workflow/t66-construction-worktrees-refactor.sh (TAP plan 4).
// Mechanism: mixed.
...
// family once carried were RETIRED at the engine cutover (see
// _construction-worktrees-helpers.sh): the CONSTRUCTION-Flow / parallel-batch /
