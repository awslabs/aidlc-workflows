...
def _make_report_data() -> ReportData:
    from reporting.collector import TestResults as UnitTestResults
...
class TestCompare:
    def test_identical_runs(self):
        ...
        assert result.unchanged == 33  # +2 v1.5 qualitative phases (design, operations)
