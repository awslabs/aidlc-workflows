...
## IDE Evaluation (experimental)

> **⚠️ Experimental / work in progress.** The IDE harness (`packages/ide-harness`)
> is scaffolding for driving the AIDLC evaluation through third-party IDE AI
...
Experimental adapters: Cursor, Cline, Copilot, Kiro, Windsurf, Antigravity.
