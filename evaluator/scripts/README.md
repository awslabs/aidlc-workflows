...
### Using the Primary Entry Point (Recommended)

The recommended way to run evaluations is through the primary `run.py` script in the repository root:
...
- Through the primary `run.py` dispatcher
