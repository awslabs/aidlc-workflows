...
description: >
  ...
  `aidlc engine runtime summary`. Never mutates workflow state, never
  emits audit events, never writes files.
argument-hint: ""
user-invocable: true
...
`{{INVOKE}} engine runtime summary --json` — the materialised,
