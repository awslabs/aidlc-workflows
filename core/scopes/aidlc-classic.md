...
are off. Sensors run and the learnings ritual runs. Under relaxed, reviewer scope stands aside for undirected work and records a
`GUARD_STOOD_ASIDE` row each time. Plan Approval, terminal review freeze,
human-turn authority, and audit remain in force.
