This project uses AI-DLC (AI-Driven Development Life Cycle) for structured development. Harness-specific setup, commands, and prerequisites live in your harness directory; see the onboarding file listed below.
...
- harness-local files the shipped block adds for your harness (for example `.claude/settings.local.json`)
