...
2. Before acting on each directive, read
   ...
   \`resume_command\` then re-runs \`next\`, \`claim\` follows the Unit claim
   ...
   while \`question\` echoes at most 240 characters plus an ellipsis. The engine
   ...
   Follow that ask's rendered route commands and preserve its pending description
   and scope; an unselected intent with pending work is not an \`intent-pick\`.
