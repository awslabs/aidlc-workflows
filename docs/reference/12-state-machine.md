...
The vendored CommonMark/GFM parser changes visibility, not the raw-content
...
Heading/answer recognition now uses the vendored CommonMark/GFM parser through
