...
harness/<name>/      # Per-harness authored surfaces; claude/, kiro/, codex/, opencode/, copilot/
...
dist/<harness>/      # GENERATED + ignored: dist/claude/, dist/kiro/, dist/codex/, dist/opencode/, dist/copilot/ — never hand-edit or commit
