...
This chapter documents the hook system architecture, all sixteen hook scripts, the audit event taxonomy, CLI tool configuration, and the deterministic utility tool.
