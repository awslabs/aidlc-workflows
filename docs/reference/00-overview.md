...
| [Hooks and Tools](06-hooks-and-tools.md) | Hook system, CLI tools, 101-event audit taxonomy |
...
| [State Machine](12-state-machine.md) | Workflow / phase / stage machines, 101-event taxonomy, audit-first rules |
