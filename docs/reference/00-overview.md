...
| [Hooks and Tools](06-hooks-and-tools.md) | Hook system, CLI tools, 92-event audit taxonomy |
...
| [State Machine](12-state-machine.md) | Workflow / phase / stage machines, 92-event taxonomy, audit-first rules |
...
| [Commit Provenance](19-commit-provenance.md) | Content-derived attribution from commits to reviewed units: committed reviewed-source evidence, `aidlc attest resolve`, `SOURCE_COMMITTED` anchors |
