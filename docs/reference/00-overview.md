...
| [Hooks and Tools](06-hooks-and-tools.md) | Hook system, CLI tools, 106-event audit taxonomy |
...
| [State Machine](12-state-machine.md) | Workflow / phase / stage machines, 106-event taxonomy, audit-first rules |
