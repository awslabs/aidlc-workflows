...
| [Hooks and Tools](06-hooks-and-tools.md) | Hook system, CLI tools, 76-event audit taxonomy |
...
| [State Machine](12-state-machine.md) | Workflow / phase / stage machines, 76-event taxonomy, audit-first rules |
