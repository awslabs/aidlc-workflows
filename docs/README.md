...
Node.js. Windows installs for the current account even when elevated and
automatically registers the bin directory in User PATH. If another session
cannot find `aidlc`, open a new terminal. Use
