...
on it should run with those four fences lowered, as the shipped `express` scope
does. To spare people a fence they meet only occasionally, use the per-work switch
