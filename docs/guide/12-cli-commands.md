...
### `aidlc engine state set-integration-mode` - select PR integration routing

```bash
aidlc engine state set-integration-mode pr
aidlc engine state set-integration-mode absent
```
