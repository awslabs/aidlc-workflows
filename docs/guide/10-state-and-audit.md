...
| **Unit Configuration and Lifecycle** | 8 | `UNIT_OWNERSHIP_SET`, `UNIT_GATE_RHYTHM_SET`, `UNIT_STARTED`, `UNIT_PAUSED`, `UNIT_RESUMED`, `UNIT_INTEGRATING`, `UNIT_COMPLETED`, `UNIT_MERGED` |
| **PR Integration** | 3 | `PR_OPENED`, `PR_FEEDBACK`, `PR_MERGED` |
