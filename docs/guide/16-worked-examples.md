...
This example builds a notification service for a task management application. The **feature** scope runs all 32 delivery-path stages at Standard depth. This walkthrough highlights key stages across all phases.
...
> Progress: 10/36 overall | IDEATION complete. Verification Gate passed.
...
> Progress: 18/36 overall | INCEPTION complete. Verification Gate passed.
...
> Progress: 25/36 overall | CONSTRUCTION complete. Verification Gate passed.
...
> Progress: 32/36 overall | OPERATION complete. Feature workflow complete.
