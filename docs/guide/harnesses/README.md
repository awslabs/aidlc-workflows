...
| **Kiro unified agent harness** (IDE ≥ 1.0 or CLI `--v3`) | `/aidlc` | [AI-DLC on the Kiro unified agent harness](kiro-unified.md) — one tree for both new-generation Kiro surfaces, Markdown agents carrying their own `permissions:`, the standalone hook manifests, what's different. |
