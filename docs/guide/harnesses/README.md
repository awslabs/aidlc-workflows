...
| Kiro CLI, Kiro IDE, and Kiro Crew | `.kiro/steering/aidlc-onboarding.md` |
...
| **Kiro Crew** | `/aidlc` | [Running AI-DLC on Kiro Crew](kirocrew.md) — the Kiro CLI distribution under the Kiro Crew product identity; the gateway-watched hook store, what's different on Kiro Crew. |
