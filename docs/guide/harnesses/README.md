...
| **GitHub Copilot** (VS Code ≥ 1.102) | `/aidlc` | [AI-DLC on GitHub Copilot](copilot.md) — the `.github/` layout, the `.agent.md` roster, the hook adapter, what's different on Copilot. |
