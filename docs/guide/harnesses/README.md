...
| **Google Antigravity** (IDE / CLI `agy`) | `/aidlc` | [AI-DLC on Google Antigravity](antigravity.md) — split `.agents/` + `.aidlc/` layout, native skills and hooks, what's different on Antigravity. |
