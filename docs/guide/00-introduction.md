...
| Scopes | 10 (enterprise through express) + auto-detect |
...
| [Workshop Mode](workshop-mode.md) | Multi-developer manual recipe for the classic scope (claim semantics via git push) |
