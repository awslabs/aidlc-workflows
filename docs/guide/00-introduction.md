...
| [Install and Lifecycle](18-install-and-lifecycle.md) | Native install, upgrades, rollback, pins, offline packages, uninstall, and [marketplace plugin installation](18-install-and-lifecycle.md#installing-plugins-from-a-marketplace) |
