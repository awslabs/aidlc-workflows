...
| Boilerplate Detection | Language-independent detection of 10+ boilerplate patterns | ✅ DONE | Excludes __init__.py, test fixtures, auto-generated code, type defs, constants, barrel files from metrics |
