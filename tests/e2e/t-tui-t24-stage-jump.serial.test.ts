...
// turn). Gated behind AIDLC_TUI_LIVE=1 so a bare `--e2e` SKIPs it; selected TUI substrate/claude/
  ...
  test.skipIf(SKIP_REASON !== null)(
    ...
    async () => {
      ...
      try {
        ...
        const sawLanded = waitFor(session, "> Approval & Handoff", remainingWorkMs(), 0);
