...
describe("t230 dispatcher help and errors", () => {
  ...
  test("all seven public commands have side-effect-free registry-derived help", () => {
    const projectDir = makeProject();
  ...
  test("all public commands reject malformed grammar before delegation or writes", () => {
    ...
    const cases: Array<{
      ...
      { command: "ui", category: "unknown", args: ["ui", "status", "--wat"], message: "unknown ui option --wat" },
      { command: "ui", category: "stray", args: ["ui", "status", "extra"], message: "unexpected ui positional" },
      { command: "ui", category: "missing", args: ["ui"], message: "ui requires a command" },
      { command: "ui", category: "unknown-command", args: ["ui", "frob"], message: "unknown ui command \"frob\"" },
      { command: "ui", category: "duplicate", args: ["ui", "status", "--json", "--json"], message: "--json may be specified only once" },
      { command: "ui", category: "incompatible", args: ["ui", "start", "--json"], message: "--json is accepted by ui status only" },
