...
//   .sh test 12 (grid EXECUTE set == subgraphForScope) -> "shipped grid EXECUTE set is cell-identical to subgraphForScope for all 12 scopes"
...
describe("scope-grid <-> subgraphForScope parity (in-process)", () => {
  test("shipped grid EXECUTE set is cell-identical to subgraphForScope for all 12 scopes [.sh test 12]", () => {
