...
afterAll(() => {
  ...
  // Dozens of fixture trees, several holding a full release copy: removing them
  // legitimately exceeds bun's 5-second hook default on slower disks.
    ...
    const expected: Record<string, Record<string, string[]>> = {
      claude: {
        ".gitignore": [
          ...
          "sha256:258afe883120d16018112ad8865a2d8a0b8e158564570e54bffe2a786ae2837f",
        ],
      },
      codex: {
        "AGENTS.md": [
