...
describe("t81 aidlc-state practices-event — bolt-plan-marker-conflict override (migrated from t81-bolt-plan-override.sh, plan 4)", () => {
  ...
  test("3: framework event count pinned at 106", () => {
    ...
    // new event. The framework total is 106: the v0.6.0 Wave 4 milestone 16
    ...
    // a per-run switch) (+3) = 105; CHECKPOINT_VERIFICATION_STARTED (the
    // clone-portable revocation a started checkpoint check records) = 106.
